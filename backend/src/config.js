...
const namePrefix = "Partybear.io nft ";
const description = "This is a party bear nft project";
...
const extraMetadata = {
  external_url: "https://partybear.io", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Partybear.io nft';
...
const PUBLIC_MINT_START_DATE = "2022-05-04T11:30:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x0D04bC6a4B77AF57B0a34F2Cd8758f5370beF79b"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "which bear will you get?"; // Replace with what you want the generic descriptions to say.
